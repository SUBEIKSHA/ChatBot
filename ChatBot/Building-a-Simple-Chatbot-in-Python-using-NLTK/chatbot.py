...
with open('D:\CODE ALPHA\ChatBot\Building-a-Simple-Chatbot-in-Python-using-NLTK\chatbot.txt', 'r', encoding='utf8', errors='ignore') as fin:
    raw = fin.read().lower()
...
# Tag configurations
chat_window.tag_config("user", foreground="red", font=("Helvetica", 15, "bold"))
chat_window.tag_config("bot", foreground="brown", font=("Helvetica", 15, "bold"))
